...
class customTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cellMakan", for: indexPath)
        as! contentTableViewCell

        // Configure the cell...
        cell.labnama.text = names[indexPath.row]
        cell.labharga.text = prices[indexPath.row]
        cell.labpromo.text = specials[indexPath.row]
